...
**Response**: I tried to do color=, but upon talking with my partner,
the fill= ended up looking better for the boxplot. The boxplots seem to
be quite distinct from eachother.
...
**Response**: The boxplot gives a good IQR explanation and how distinct
the data points are away from eachother. The jitterplot illustrates a
bit more of the spread of individuals within the samples. It still
follows the clusters fairly closely.
